...
uint256 hashGenesisBlock("0x19d0c81d5bfa816012b385c3a7fa0beedd7a3d0b87a1fdd02d95dcaedf291915");
...
const string strMessageMagic = "NextCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 10000000 * COIN;	// 1000 billion coins, that all pow coins
	}

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 12 * 24 * 60 * 60; // NextCoin: 0.35 days
static const int64 nTargetSpacing = 120; // NextCoin: 2 mins 
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nextcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NextCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbec4fc62c28444d4b8968d8b912a28c8fad981ea7cc4bb0f9ffac0d26dcf77a9");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "My First NextCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x6ef687ee817d60aa10417ccf8d972dd61cdef86e1b7741499c7574f7f2438a11"));
